...
var gidentity = (function () {
	...
	function getToken() {
		...
		chrome.identity.getAuthToken({
			...
			function (token) {
			if (chrome.runtime.lastError) { // something happened
 ...
 *
 * @param str - error message returned in case of failure
 * @param int - XHR response status code
 * @param obj - XHR response data
 * @return void
 */
